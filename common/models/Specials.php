 ...
 * @property integer $image_action_id
 ...
 * @property Files $imageAction
 * @property Files $imageRr
 * @property Files $imagePreview
 */
class Specials extends PrototypeModel
{
    const PATH = '/specials/';
    ...
    const IMAGE_ACTION_FILE = 'imageActionFile';
    const IMAGE_ACTION_ID = 'image_action_id';
    ...
    public function behaviors()
    {
        return [
            ...
            [
                'class' => FilesBehavior::className(),
                'path' => self::PATH,
                'column' => self::IMAGE_ACTION_ID,
                'field' => self::IMAGE_ACTION_FILE
            ]
        ];
    }
    ...
    public function rules()
    {
        return [
            ...
            [['image_preview_id', 'image_header_id', 'image_rr_id', 'publish', 'is_finished'], 'integer'],
            [['date'], 'safe'],
            ...
            [['image_action_id'], 'exist', 'skipOnError' => true, 'targetClass' => Files::className(), 'targetAttribute' => ['image_action_id' => 'id']],
            [['name', 'title'], 'trim'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'name' => 'Название акции\спецпредложения',
            'slogan' => 'Слоган',
            'title' => 'Title',
            ...
            'imageActionFile' => 'Изображение для слайдера на главной',
            'name_rr' => 'Название',
            'imageRrFile' => 'Фото',
    ...
    {
        return $this->hasOne(Files::className(), ['id' => 'image_action_id']);
    }
    ...
    {
        return Url::toRoute(['specials/page', 'alias' => $this->alias]);
    }
